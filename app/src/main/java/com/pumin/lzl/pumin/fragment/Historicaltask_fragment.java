...
import com.intentpumin.lsy.intentpumin.AdminDevicesActivity;
...
public class Historicaltask_fragment extends Fragment {
    ...
    private void init() {
        ...
        sdate = (TextView) view.findViewById(R.id.tv_date_start);
        //日期
        sdate.setClickable(true);
        sdate.setFocusable(true);
        edate = (TextView) view.findViewById(R.id.tv_date_end);
        edate.setClickable(true);
        edate.setFocusable(true);
        et_yunxing = (Button) view.findViewById(R.id.et_yunxing);
        et_yunxing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent inter =getActivity().getIntent();
                inter.setClass(getContext(), AdminDevicesActivity.class);
    ...
    private void requestData(List<String> eqptIds, List<String> statIds) {
        ...
        HttpUtil.getInstance().post(MainLogic.GET_VALUE, params, new StringHttpRequestCallback() {
            ...
            protected void onSuccess(String s) {
                ...
                // 这里
                if (result.getRes() == 1) {
                    Toast.makeText(getContext(), "后台获取数据成功", Toast.LENGTH_SHORT).show();
...
//        distanceAxis.setName("Distance");
    ...
    private class ChartAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.item_value_list, null);
