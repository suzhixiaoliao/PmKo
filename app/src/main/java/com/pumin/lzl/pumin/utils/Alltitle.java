 ...
 * 头部标题工具包
 * <p>
 * 作者：lzl on 2016/6/8 13:22
 * 邮箱：zhilin——comeon@163.com
 */
public class Alltitle extends FrameLayout implements View.OnClickListener {
    ...
    public Alltitle(Context context) {
        this(context, null);
    }

    public Alltitle(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Alltitle(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface onTextTitleClickListener {
        public void onTitleClick(View textview);
    }
