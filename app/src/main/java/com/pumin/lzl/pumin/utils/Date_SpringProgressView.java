...
* 自定义进度条-工具包--日期进度条
*/
public class Date_SpringProgressView extends View {
    ...
    public Date_SpringProgressView(Context context, AttributeSet attrs,
                                   int defStyleAttr) {
    ...
    public Date_SpringProgressView(Context context) {
        super(context);
        initView(context);
    }
