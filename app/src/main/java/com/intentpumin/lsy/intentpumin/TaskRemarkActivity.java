...
public class TaskRemarkActivity extends Activity {
   ...
   // remark_list list=  new remark_list();
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* items = (task_get) getIntent().getSerializableExtra("lsytask");
        if (items != null) {
       ...
       // String mRemark = et_tast_com.getText().toString();
        ...
        bt_tast_qx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent intent=new Intent(TaskRemarkActivity.this,DataExecuteTasks2Activity.class);
                TaskRemarkActivity.this.startActivity(intent);*/
            }
        });
...
//                        String remark= resulut.getRemark();
                     //   init(remark);
                    }
