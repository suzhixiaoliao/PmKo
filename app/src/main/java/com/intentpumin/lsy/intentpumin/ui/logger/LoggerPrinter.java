...
import com.intentpumin.lsy.intentpumin.ui.logger.util.ArrayUtil;
import com.intentpumin.lsy.intentpumin.ui.logger.util.SystemUtil;
...
final class LoggerPrinter implements Printer {
  ...
  public Settings init(String tag) {
    ...
    com.intentpumin.lsy.intentpumin.ui.logger.LoggerPrinter.TAG = tag;
    return settings;
  }
  ...
  private int getStackOffset(StackTraceElement[] trace) {
    for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
      ...
      if (!name.equals(com.intentpumin.lsy.intentpumin.ui.logger.LoggerPrinter.class.getName()) && !name.equals(Logger.class.getName())) {
        return --i;
      }
    }
    return -1;
