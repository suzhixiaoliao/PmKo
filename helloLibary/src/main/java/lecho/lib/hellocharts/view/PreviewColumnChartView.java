...
/**
 * Preview chart that can be used as overview for other ColumnChart. When you
 * change Viewport of this chart, visible area of other chart will change. For
 * that you need also to use
...
public class PreviewColumnChartView extends ColumnChartView {
	...
	public PreviewColumnChartView(Context context, AttributeSet attrs,
		...
		previewChartRenderer = new PreviewColumnChartRenderer(context, this,
				this);
