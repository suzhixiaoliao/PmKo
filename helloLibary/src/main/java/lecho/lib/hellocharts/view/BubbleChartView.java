 ...
 * @author lecho
 */
public class BubbleChartView extends AbstractChartView implements
	...
	public void callTouchListener() {
		...
		if (selectedValue.isSet()) {
			BubbleValue value = data.getValues().get(
	...
	public void setOnValueTouchListener(
			BubbleChartOnValueSelectListener touchListener) {
	...
	/**
	 * Removes empty spaces, top-bottom for portrait orientation and left-right
	 * for landscape. This method has to be called after view
	 * View#onSizeChanged() method is called and chart data is set. This method
	 * may be inaccurate.
	 * 
